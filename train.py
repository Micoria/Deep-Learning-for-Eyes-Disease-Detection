...
# 加载训练集和验证集
train_data = LoadData(r"/Users/micoria/Documents/python/DL/SqueezeNet/train.txt", True)
train_dl = torch.utils.data.DataLoader(train_data, batch_size=16, pin_memory=True,
                                           shuffle=True, num_workers=0)
test_data = LoadData(r"/Users/micoria/Documents/python/DL/SqueezeNet/valid.txt", True)
